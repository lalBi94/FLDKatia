...
export default function Customer() {
    ...
    useEffect(() => {
        ...
        if (userD.isEmpty) {
            ...
            cipherRequest(toSend, `${config.api}/customer/getInfo`).then(
                (res) => {
                    if (!res || res.status === 1) {
                        localStorage.removeItem("katiacm");
                        window.location.href = "/#/gate";
            ...
            setUserData(userD);
            handleMyAccount(userD);
        }
    }, []);

    return (
        <ConfigProvider theme={customer}>
            <Layout>
                {userData ? (
                    <div id="customer-container">
                        <div id="customer-header">
                            <div id="customer-header-txt">
                                <div id="customer-title-cont">
                                    ...
                                    <h4 id="customer-subtitle">
                                        Sur cette page, trouvez toutes les infos
